...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_BUF_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_PAIRED, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_CLIENT_GROUP_STREAM_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_CLIENT_ASE_SNK_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_CLIENT_ASE_SRC_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MCS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DYNAMIC_DB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UTF8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCTL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCTL_LOCAL_PLAYER_CONTROL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCTL_LOCAL_PLAYER_REMOTE_CONTROL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CCID, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_CLIENT_GROUP_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_UNICAST_CLIENT_PAC_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCS_CLIENT_MAX_VOCS_INST, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCS_CLIENT_MAX_AICS_INST, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_MEDIA_PLAYER_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_MEDIA_PLAYER_NAME_MAX, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_ICON_URL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_ICON_URL_MAX, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_TRACK_TITLE_MAX, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_SEGMENT_NAME_MAX, 25);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MPL_GROUP_TITLE_MAX, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCTL_LOCAL_PLAYER_LOCAL_CONTROL, 1);
